        ...
        return new CommandAPICommand("msg")
                ...
                .withArguments(new StringArgument("player")
                                .replaceSuggestions(ArgumentSuggestions.strings(commandSenderSuggestionInfo ->
                                        plugin.getPlayerListManager().getPlayers(commandSenderSuggestionInfo.sender()).stream()
                ...
                .executes((sender, args) -> {
                    try {
                        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
                            ...
                            if (!plugin.getPlayerListManager().getPlayers(sender).contains(receiverName)) {
